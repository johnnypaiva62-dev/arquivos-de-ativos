...
async def fii_proventos(ticker: str, max_docs: int = 200):
    ...
    for doc in docs:
        ...
        # Verificar se é documento de rendimento/amortização pelo nome
        desc_lower = descricao.lower()
        if not any(kw in desc_lower for kw in ["rendiment", "amortiza", "provento", "dividendo"]):
            # Pode ser outro tipo de documento, pular
            continue
